...
urlpatterns = [
   path('HomePage/',views.homepage,name='HomePage'),
    ...
    path('concession_request/', views.concession_request, name='concession_request'),
    path('reject_concession/', views.reject_concession, name='reject_concession'),
    path('approve_concession/', views.approve_concession, name='approve_concession'),
]
